...
function Carousel({
  ...
  React.useEffect(() => {
    ...
    // Delay the initial state update to avoid synchronous state updates in the effect,
    // which can trigger cascading renders and cause React warnings.
...
function CarouselPrevious({
  ...
  return (
    <Button
      ...
      disabled={api ? !canScrollPrev : undefined}
      onClick={scrollPrev}
      {...props}
    >
      <ArrowLeft />
...
function CarouselNext({
  ...
  return (
    <Button
      ...
      disabled={api ? !canScrollNext : undefined}
      onClick={scrollNext}
      {...props}
    >
      <ArrowRight />
