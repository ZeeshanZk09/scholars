...
- Name: admin-journey.spec.ts >> Admin journey (Phase 25) >> authenticated admin can publish a blog and it appears publicly
- Location: tests\e2e\admin-journey.spec.ts:35:7
...
waiting for navigation to "/admin" until "load"
  navigated to "http://127.0.0.1:3000/auth/login?email=admin%40scholarschool.edu.pk&password=Admin%4012345"
============================================================
```
